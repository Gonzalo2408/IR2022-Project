"""Converts TREC-COVID queries and corpus into TFRecord that will be consumed by BERT.
...
flags.DEFINE_integer(
    "num_train_docs", 50, "The number of docs per query for the training set."
)

flags.DEFINE_integer(
    "num_dev_docs", 50, "The number of docs per query for the development set."
)

flags.DEFINE_integer(
    "num_test_docs", 1000, "The number of docs per query for the test set."
)
...
def load_corpus(path):
    ...
    # corpus[data[i]['title']] = data[i]['paragraph']
...
def main():
    ...
    for set_name, qrels_path, run_path in [
        ...
        convert_dataset(
            data=data, corpus=corpus, set_name=set_name, tokenizer=tokenizer
        )
